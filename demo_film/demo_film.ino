...
{ 
  ...
  if(device_state == "on"){
    ...
    outputResult += "<p></p>";
    outputResult += "<a href=\"/\"><button class=\"button\">Play again</button></a>";
...
float change_kg( float value ){
  value = 111.92 * pow ( 2.7182 , ( 0.001*value ) );  //轉換為公克(g) 
